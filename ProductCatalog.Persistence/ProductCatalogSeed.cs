    ...
    public class ProductCatalogSeed
    {
        ...
        static IEnumerable<CatalogItem> GetPreconfiguredItems()
        {
            return new List<CatalogItem>()
            {
                ...
                //new CatalogItem() { CatalogTypeId=2,CatalogBrandId=2, Description = "Lala Land", Name = "Blue Star", Price = 112, PictureUrl = "http://storage/api/pic/6",PictureFileName=string.Empty },
                //new CatalogItem() { CatalogTypeId=2,CatalogBrandId=1, Description = "High in the sky", Name = "Roslyn Green", Price = 212, PictureUrl = "http://storage/api/pic/7",PictureFileName=string.Empty  },
                //new CatalogItem() { CatalogTypeId=1,CatalogBrandId=1, Description = "Light as carbon", Name = "Deep Purple", Price = 238.5M, PictureUrl = "http://storage/api/pic/8",PictureFileName=string.Empty },
                //new CatalogItem() { CatalogTypeId=1,CatalogBrandId=2, Description = "High Jumper", Name = "Addidas<White> Running", Price = 129, PictureUrl = "http://storage/api/pic/9",PictureFileName=string.Empty },
                //new CatalogItem() { CatalogTypeId=2,CatalogBrandId=3, Description = "Dunker", Name = "Elequent", Price = 12, PictureUrl = "http://storage/api/pic/10" ,PictureFileName=string.Empty},
                //new CatalogItem() { CatalogTypeId=1,CatalogBrandId=2, Description = "All round", Name = "Inredeible", Price = 248.5M, PictureUrl = "http://storage/api/pic/11",PictureFileName=string.Empty },
                //new CatalogItem() { CatalogTypeId=2,CatalogBrandId=1, Description = "Pricesless", Name = "London Sky", Price = 412, PictureUrl = "http://storage/api/pic/12" ,PictureFileName=string.Empty},
                //new CatalogItem() { CatalogTypeId=3,CatalogBrandId=3, Description = "Tennis Star", Name = "Elequent", Price = 123, PictureUrl = "http://storage/api/pic/13",PictureFileName=string.Empty },
                //new CatalogItem() { CatalogTypeId=3,CatalogBrandId=2, Description = "Wimbeldon", Name = "London Star", Price = 218.5M, PictureUrl = "http://storage/api/pic/14",PictureFileName=string.Empty },
